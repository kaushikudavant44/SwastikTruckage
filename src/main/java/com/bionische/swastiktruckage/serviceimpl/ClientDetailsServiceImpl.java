...
public class ClientDetailsServiceImpl implements ClientDetailsService{
	...
	@Override
	public ClientDetails getClientDetailsById(int clientId)
	{
		ClientDetails res = new ClientDetails();
		try
		{
			res = clientDetailsRepository.findByClientId(clientId);		
	...
	@Override
	public Info deleteClientById(int clientId)
	{
		int res=0;
		Info info = new Info();
		try
		{
			res = clientDetailsRepository.deleteClientById(clientId);		
