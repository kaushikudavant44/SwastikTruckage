				...
				<div class="col-xs-12 col-sm-12">
					<div class="cardview">
						...
						<div class="card-body card-block">
							<form action="${pageContext.request.contextPath}/insertStaffRole"
								method="post">
								<div class="row">
									<div class="col-md-2">
									Role 
									...
									<div class="col-md-6">
										...
										<div class="input-group">
											<input class="form-control" name="roleName" id="Name"
												type="text" required
							...
							<div class="row">
									...
									<div class="col-md-6">
						<textarea class="form-control" name="role" rows="2" id="address" autocomplete="off"
