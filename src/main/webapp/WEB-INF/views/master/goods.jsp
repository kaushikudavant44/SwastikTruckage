				...
				<div class="col-xs-12 col-sm-12">
					<div class="card">
						...
						<div class="card-body card-block">
							<form action="${pageContext.request.contextPath}/insertGoods"
								method="post">
								<div class="row">
									<div class="col-md-2">
									Goods Name 
									</div>
									<input class="form-control" name="goodsId" id="goodsId" value="${goods.goodsId}"
												type="hidden" />
									<div class="col-md-6">

										<div class="input-group">
											<input class="form-control" name="goods" id="goods" value="${goods.goodsName}"
