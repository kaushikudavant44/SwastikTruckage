...
<script type="text/javascript">
	...
	function getReceivedLrDetails(){
		...
		$.getJSON('${getLrDetails}', {
			...
			selectedLrHeaderId.push(data.lrHeaderId);
							...
							tr.append($('<td></td>').html("<a style='cursor:pointer; color:blue;' onclick='editLr("+data.lrHeaderId+")'><i class='fa fa-edit'></i> </a>"));
	...
	function editLr(lrHeaderId){
		
		window.open("${pageContext.request.contextPath}/editLRDetails/"+lrHeaderId,"_self");
