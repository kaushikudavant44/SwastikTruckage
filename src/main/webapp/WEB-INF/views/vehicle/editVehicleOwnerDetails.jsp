						...
						<div class="card-body">
							...
							<div class="form-group">
								<label class=" form-control-label">Full Name</label>
										<input required name="ownerName" class="form-control" value="${vehicleOwner.ownerName}">							
							</div>							
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input required class="form-control" name="contactNo" value="${vehicleOwner.ownerContactNo}">
								</div>
							</div>
							</div>
