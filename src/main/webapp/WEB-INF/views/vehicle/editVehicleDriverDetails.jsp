						...
						<div class="card-body">
							...
							<div class="form-group">
								<label class=" form-control-label">Driver Name</label>
										<input required name="name" class="form-control" value="${vehiclesDrivers.driverName}">							
							</div>							
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input required class="form-control" name="contactNo" value="${vehiclesDrivers.driverContactNo}">
								</div>
							</div>
							</div>
							...
							<select required data-placeholder="Choose a Owner..."
								...
								<c:forEach items="${vehicleDetails}" var = "vehicleDetails">
									   <c:choose>
                                            <c:when test = "${vehicleDetails.vehId==vehiclesDrivers.vehId}">
                                                <option selected  value ="${vehicleDetails.vehId}">${vehicleDetails.vehNo }</option>
                                            </c:when>
                                            <c:otherwise>
                 				                 <option  value ="${vehicleDetails.vehId}">${vehicleDetails.vehNo }</option>
                                            </c:otherwise>
                                       </c:choose>
				                     </c:forEach>
							</select>
							...
							<div class="form-group">
								<label class=" form-control-label">License No</label>
										<input required name="licenseNo" class="form-control" value="${vehiclesDrivers.driverLicenseNo}">							
							</div>							
							</div>
